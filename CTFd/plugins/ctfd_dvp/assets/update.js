...
// Показ/скрытие опций ВМ при изменении типа окружения
$('#environment_type').change(function() {
    if ($(this).val() === 'virtualmachine') {
...
$(document).ready(function() {
    ...
    // Инициализация видимости опций ВМ при загрузке
    if ($('#environment_type').val() === 'virtualmachine') {
        $('#container_options').hide();
        $('#vm_options').show();
    }
});

console.log('[DVP] Update script loaded');